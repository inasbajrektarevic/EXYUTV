...
namespace Iptv.Shared
{
    public class Email : IEmail
    {
        ...
        public Email()
        {
            ...
            _username = Environment.GetEnvironmentVariable("SMTP_USERNAME") ?? "iptv.blkn.app@gmail.com";
            _password = Environment.GetEnvironmentVariable("SMTP_PASSWORD") ?? "reak ereo tsmn mlwz";
            _displayName = Environment.GetEnvironmentVariable("MAIL_DISPLAY_NAME") ?? "iptv_blkn.ba";
            _fromAddress = Environment.GetEnvironmentVariable("MAIL_FROM_ADDRESS") ?? "no-replay@iptv.ba";
        }
